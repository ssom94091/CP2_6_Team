...
<body>
    <div class="card-test">
        ...
        <table  border="1" id="dataTable"  width="100%" cellspacing="0" >
          ...
          $sql = "SELECT * FROM pitcher_".$_REQUEST['tmp_year'];
          ...
          if (mysqli_num_rows($result) > 0) {
             while($row = mysqli_fetch_assoc($result)) {
                 echo "<tr><td>" . $row["순"]. "</td><td>" . $row["이름"]. "</td><td>" . $row["팀"]. " </td><td>" . $row["WAR"]. "</td><td>" . $row["출장"]. 
                 "</td><td>" . $row["완투"]. "</td><td>" . $row["완봉"]. "</td><td>" . $row["선발"]. " </td><td>" . $row["승"]. "</td><td>" . $row["패"].
                 "</td><td>" . $row["세"]. "</td><td>" . $row["홀드"]. "</td><td>" . $row["이닝"]. "</td><td>" . $row["실점"]. "</td><td>" . $row["자책"].
                 "</td><td>" . $row["타자"]. "</td><td>" . $row["안타ㅓ,"]. "</td><td>+" . $row["2타"]. "</td><td>" . $row["3타"]. "</td><td>" . $row["홈런"]. "</td><td>" . $row["볼넷"].
                 "</td><td>" . $row["고4"]. "</td><td>" . $row["사구"]."</td><td>" . $row["삼진"]."</td><td>" . $row["보크"]."</td><td>" . $row["폭투"]."</td><td>" . $row["ERA"]."</td><td>" . $row["FIP"]."</td><td>" . $row["WHIP"]."</td><td>" . $row["ERA+"]."</td><td>" . $row["FIP+"]."</td><td>" . $row["WPA"]."</td></tr>";
             }
         }else{
             echo "테이블에 데이터가 없습니다.";
         }
