...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
      ...
      <div class="card-test">  
        ...
        <select id="table" onchange="datatable.src=this.value+'.php'" >
            <option value="defender_data">defender_data</option>
            <option value="hitter_data">hitter_data</option>
            <option value="pitcher_data">pitcher_data</option>
            <option value="team_data">team_data</option>
            <option value="statiz_game_data">statiz_game_data</option>
            <option value="statiz_game_entry">statiz_game_entry</option>

        </select>
        <div>

            <iframe src="defender_data.php"
            id="datatable"
            width="100%"
            height="500" 
            > 
