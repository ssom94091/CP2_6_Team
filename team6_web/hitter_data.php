    ...
    <div class="card-test">
        ...
        <table  border="1" id="dataTable"  width="100%" cellspacing="0" >
            ...
            <tbody>
                ...
                $year = "".$_REQUEST['tmp_year'];
                echo "<p> ".$year."</p>";
               // echo "<p> $year </p>";
          $conn = mysqli_connect("13.125.93.72", "test", "test", "kbo_data"); // MYSQL에 접속
          $query = "SHOW TABLES FROM kbo_data";
          if(year){ $sql = "SELECT * FROM hitter_".$_REQUEST['tmp_year'];}
          else{$sql = "SELECT * FROM hitter_2017"; }
          ...
          if (mysqli_num_rows($result) > 0) {
             while($row = mysqli_fetch_assoc($result)) {
                 ...
                 "</td><td>" . $row["3타"]. "</td><td>" . $row["홈런"]. "</td><td>" . $row["루타"]. "</td><td>" . $row["타점"]. "</td><td>" . $row["도루"].
                 "</td><td>" . $row["도실"]. "</td><td>" . $row["볼넷"]. "</td><td>+" . $row["사구"]. "</td><td>" . $row["고4"]. "</td><td>" . $row[삼진]. "</td><td>" . $row["병살"].
                 "</td><td>" . $row["희타"]. "</td><td>" . $row["희비"]."</td><td>" . $row["타율"]."</td><td>" . $row["출루"]."</td><td>" . $row["장타"]."</td><td>" . $row["ops"]."</td><td>" . $row["woba"]."</td><td>" . $row["wrc+"]."</td><td>" . $row["wpa"]."</td></tr>";
             }
         }else{
             echo "테이블에 데이터가 없습니다.";
         }
