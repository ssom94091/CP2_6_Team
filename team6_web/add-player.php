...
<div class="container-fluid">
    ...
    <div class="container-fluid">
        ...
        <!-- Page Heading -->
        <h1 class="h3 mb-2 text-gray-800">Add_player</h1>
        <p class="mb-4">선수 데이터 추가</p>

        <div class="card-body">
         <form action="players.php" method="post">  <!-- 등록된 선수 보기-->.
             <input type="submit"  value="등록된 선수보기" >
            </form>
           <form action="" method="post">
            ...
            <td>
                <input type="text" placeholder="팀명" list="teams" name="teamname">
                <datalist id="teams">
         ...
         <td>
            <input type="text" placeholder="포지션" list="position" name="po">
        ...
        <td><input type="text" placeholder="성명" name="names">
        </td>
        <td><input type="text" placeholder="등번호" name="backnum">
        </td>
...
$birth = $_POST["birth"];
$start_check = 0;
echo "입력된 데이터 값 : ".$teamname.",".$po.",".$names.",".$backnum.",".$birth;
        if($teamname!=NULL&&$po!=NULL&&$names!=NULL&&$backnum!=NULL&&$birth!=NULL){
            $conn = mysqli_connect("13.125.93.72", "test", "test", "kbo_data"); // MYSQL에 접속
            $sql = "SELECT * FROM Players";
            mysqli_query($conn,$sql);
            mysqli_query($conn,"INSERT INTO Players (팀,포지션,성명,등번호,생년월일) VALUES('".$teamname."','".$po."','".$names."','".$backnum."','".$birth."')");
                 echo "<script>alert('DB등록이 성공적으로 완수되었습니다.');</script>";
